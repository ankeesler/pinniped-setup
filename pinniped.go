...
func addPinnipedControllersToManager(mgr ctrl.Manager, config *config) error {
...
func newController(config *config, client client.Client) *pinnipedController {
	return &pinnipedController{config: config, client: client}
}

func (c *pinnipedController) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (c *pinnipedController) serviceAddress(ctx context.Context, s *corev1.Service) (string, string, error) {
...
func (c *pinnipedController) serviceAddresses(ctx context.Context, s *corev1.Service) ([]string, []string, error) {
	switch s.Spec.Type {
...
func (c *pinnipedController) loadBalancerServiceAddresses(s *corev1.Service) ([]string, []string, error) {
	ipAddresses := []string{}
	dnsNames := []string{}
...
func (c *pinnipedController) nodePortServiceAddresses(ctx context.Context, s *corev1.Service) ([]string, []string, error) {
...
func (c *pinnipedController) clusterAddress(ctx context.Context) (string, error) {
...
func (c *pinnipedController) certCAData(ctx context.Context, cert *certmanagerv1beta1.Certificate) (string, error) {
...
func (c *pinnipedController) apply(ctx context.Context, obj client.Object, applyFunc func(obj client.Object)) (client.Object, error) {
...
func federationDomainAndSupervisorServingCertCADataToJWTAuthenticatorFunc(federationDomain *supervisorconfigv1alpha1.FederationDomain, supervisorServingCertCAData string) func(obj client.Object) {
	return func(obj client.Object) {
		...
		jwtAuthenticator.Spec.Audience = federationDomain.Spec.Issuer // TODO: this only works for managment cluster.
